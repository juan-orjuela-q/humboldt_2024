document.addEventListener("DOMContentLoaded", function () {
  ...
  const municipalitiesData = {
    1: { name: "San Onofre", x: 32, y: 20, region: "costa" },
    2: { name: "Santiago De Tolu", x: 29, y: 34, region: "costa" },
    3: { name: "Chalán", x: 43, y: 31, region: "montes" },
    4: { name: "Ovejas", x: 51, y: 32, region: "montes" },
    5: { name: "Coloso", x: 41, y: 35, region: "montes" },
    6: { name: "Tolu Viejo", x: 33, y: 37, region: "montes" },
    7: { name: "Los Palmitos", x: 50, y: 37, region: "planicie" },
    8: { name: "San Pedro", x: 62, y: 41, region: "planicie" },
    9: { name: "Morroa", x: 42, y: 40, region: "planicie" },
    10: { name: "Coveñas", x: 19, y: 39, region: "costa" },
    11: { name: "Palmito", x: 27, y: 44, region: "planicie" },
    12: { name: "Sincelejo", x: 36, y: 45, region: "planicie" },
    13: { name: "San Juan Betulia", x: 46, y: 46, region: "planicie" },
    14: { name: "Buenavista", x: 69, y: 45, region: "planicie" },
    15: { name: "Since", x: 59, y: 47, region: "planicie" },
    16: { name: "Sampués", x: 36, y: 52, region: "planicie" },
    17: { name: "Corozal", x: 49, y: 52, region: "planicie" },
    18: { name: "Galeras", x: 66, y: 54, region: "planicie" },
    19: { name: "El Roble", x: 53, y: 58, region: "planicie" },
    20: { name: "San Benito Abad", x: 68, y: 73, region: "planicie" },
    21: { name: "La Unión", x: 44, y: 71, region: "planicie" },
    22: { name: "Calimito", x: 57, y: 73, region: "planicie" },
    23: { name: "Sucre", x: 83, y: 71, region: "planicie" },
    24: { name: "San Marcos", x: 54, y: 83, region: "planicie" },
    25: { name: "Majagual", x: 84, y: 85, region: "planicie" },
    26: { name: "Guaranda", x: 83, y: 96, region: "planicie" },
  };
